...
@foreach($certificados as $certificado)
    ...
    @endif
    <div style="border: 0px solid red;position: absolute;top: 240px;left: 110px;text-align: center;font-size: 2.8em; font-weight: bold;width: 870px;height: 35px;font-family: 'Nunito', sans-serif;color: #343c47">{{$certificado['titulo']}}</div>
    <div style="border: 0px solid red;position: absolute;top: 310px;left: 120px;text-align: center;font-size: 2em; font-weight: bold;width: 850px;height: 35px;font-family: 'Nunito', sans-serif;color: #343c47">A: {{$certificado['nombres']}}</div>
    ...
    <div style="border: 0px solid red;position: absolute;top: 480px;left: 120px;text-align: left;font-size: 1em;width: 850px;height: 85px;font-family: 'Nunito', sans-serif;color: #343c47">
