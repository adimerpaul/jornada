...
@foreach($certificados as $certificado)
    ...
    <div style="border: 1px solid red;position: absolute;top: 400px;left: 100px;text-align: justify;font-size: 1em;width: 850px;height: 85px;font-family: 'Nunito', sans-serif;color: #343c47">
    ...
    <div style="border: 1px solid red;position: absolute;top: 550px;left: 100px;text-align: center;font-size: 0.8em;width: 850px;height: 85px;font-family: 'Nunito', sans-serif;color: #343c47">
