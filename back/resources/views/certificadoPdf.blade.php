...
@foreach($certificados as $certificado)
    ...
    <div style="border: 1px solid red;position: absolute;top: 310px;left: 120px;text-align: center;font-size: 2.5em; font-weight: bold;width: 850px;height: 35px;font-family: 'Nunito', sans-serif;color: #343c47">{{$certificado['nombres']}}</div>
    <div style="border: 1px solid red;position: absolute;top: 380px;left: 120px;text-align: justify;font-size: 1em;width: 850px;height: 85px;font-family: 'Nunito', sans-serif;color: #343c47">
    ...
    <div style="border: 1px solid red;position: absolute;top: 480px;left: 120px;text-align: left;font-size: 1em;width: 850px;height: 85px;font-family: 'Nunito', sans-serif;color: #343c47">
        Oruro, Noviembre de 2022
    </div>
    <div style="border: 1px solid red;position: absolute;top: 550px;left: 120px;text-align: center;font-size: 0.6em;width: 850px;height: 85px;font-family: 'Nunito', sans-serif;color: #343c47">
