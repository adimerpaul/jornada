...
@foreach($certificados as $certificado)
    ...
    <div style="border: 0px solid red;position: absolute;top: 325px;left: 70px;text-align: center;font-size: 2em; font-weight: bold;width: 850px;height: 35px;font-family: 'Nunito', sans-serif;color: #343c47">A: {{$certificado['nombres']}}</div>
