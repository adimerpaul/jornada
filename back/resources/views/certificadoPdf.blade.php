...
@foreach($certificados as $certificado)
    ...
    @endif
    <div style="border: 0px solid red;position: absolute;top: 240px;left: 120px;text-align: center;font-size: 2.9em; font-weight: bold;width: 850px;height: 35px;font-family: 'Nunito', sans-serif;color: #343c47">{{$certificado['titulo']}}</div>
