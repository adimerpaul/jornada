...
<img src="data:image/png;base64, {!! $credencial['qr'] !!}" style="background : white ; border:2px solid white;position: absolute;top: 300px;left: 60px;width: 160px;height: 50px">
