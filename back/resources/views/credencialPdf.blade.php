...
<img src="imagenes/{{$credencial['foto']}}" style="position: absolute;top: 120px;left: 112px;width: 80px;height: 80px;border-radius: 40px" >
<div style="border:1px solid red;text-align: center;position: absolute;top: 230px;left: 45px;font-size: 14px; font-weight: bold;width: 210px;height: 40px;font-family: 'Nunito', sans-serif;color: #373e48;text-align: center">{{$credencial['nombres']}}</div>
