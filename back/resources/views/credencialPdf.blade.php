...
<img src="data:image/png;base64, {!! $credencial['qr'] !!}" style="background : white ; border:2px solid white;position: absolute;top: 295px;left: 60px;width: 170px;height: 50px">
