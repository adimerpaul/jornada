...
<div style="text-align: center;position: absolute;top: 200px;left: 20px;font-size: 8px; font-weight: bold;width: 200px;height: 15px;width: 150px;height: 15px;font-family: 'Nunito', sans-serif;color: #373e48;background-color: white">{{$credencial['nombres']}}</div>
<div style="text-align: center;position: absolute;top: 220px;left: 20px;font-size: 12px; font-weight: bold;width: 200px;height: 15px;width: 150px;font-family: 'Nunito', sans-serif;color: #373e48;background-color: white">{{$credencial['tipo']}}</div>
<div style="text-align: center;position: absolute;top: 242px;left: 20px;font-size: 8px; font-weight: bold;width: 200px;height: 15px;width: 150px;font-family: 'Nunito', sans-serif;color: #373e48;background-color: white">{{$credencial['carrera']}}</div>
