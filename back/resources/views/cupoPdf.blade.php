...
@foreach($cupos as $cupo)
    @if($loop->index%2==0)
        ...
        <img src="data:image/png;base64, {!! $cupo['qr'] !!}" style="border:2px solid white;position: absolute;top: 525px;left: 420px;width: 90px;height: 90px">
    ...
    @else
        ...
        <img src="data:image/png;base64, {!! $cupo['qr'] !!}" style="border:2px solid white;position: absolute;top: 525px;right: 25px;width: 90px;height: 90px">
