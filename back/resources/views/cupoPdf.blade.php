...
{{--        <img src="nom.jpg" style="  position: absolute;top: 300px;left: 35px;width: 150px;height: 45px" >--}}
        <div style="position: absolute;top: 400px;left: 35px;width: 250px;height: 40px;font-family: 'Nunito', sans-serif;color: #000;padding: 5px;background: #f6f9fc ;border: 2px solid #22254b;border-radius: 5px">Nombre............................---</div>
    @else
