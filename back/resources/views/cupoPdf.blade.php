...
@foreach($cupos as $cupo)
    @if($loop->index%2==0)
        ...
        <img src="nom.jpg" style="  position: absolute;top: 650px;left: 25px;width: 30px;height: 15px" >
{{--        <div style="position: absolute;top: 753px;left: 490px; font-weight: bold;width: 85px;height: 85px;font-family: 'Nunito', sans-serif;color: #a0aec0">Nombre............................ Valido hasta </div>--}}
    @else
