...
@foreach($cupos as $cupo)
    @if($loop->index%2==0)
        <img src="folleto3.jpg" style="  position: absolute;top: 5px;left: 5px;width: 518px;height: 800px" >
...
{{--        <img src="nom.jpg" style="  position: absolute;top: 300px;left: 35px;width: 150px;height: 45px" >--}}
    ...
    @else
        <img src="folleto3.jpeg" style="  position: absolute;top: 5px;right: 5px;width: 518px;height: 800px" >
