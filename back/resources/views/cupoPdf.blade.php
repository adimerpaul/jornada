...
@foreach($cupos as $cupo)
    @if($loop->index%2==0)
        ...
        <img src="data:image/png;base64, {!! $cupo['qr'] !!}" style="position: absolute;top: 575px;left: 420px;width: 90px;height: 90px">
    ...
    @else
        ...
        <img src="data:image/png;base64, {!! $cupo['qr'] !!}" style="position: absolute;top: 575px;right: 25px;width: 90px;height: 90px">
