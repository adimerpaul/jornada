...
@foreach($cupos as $cupo)
    @if($loop->index%2==0)
        ...
        <img src="data:image/png;base64, {!! $cupo['qr'] !!}" style="border:2px solid white;position: absolute;top: 650px;left: 400px;width: 90px;height: 90px">
...
{{--        <img src="nom.jpg" style="  position: absolute;top: 300px;left: 35px;width: 150px;height: 45px" >--}}
    ...
    @else
        ...
        <img src="data:image/png;base64, {!! $cupo['qr'] !!}" style="border:2px solid white;position: absolute;top: 650px;right: 30px;width: 90px;height: 90px">
